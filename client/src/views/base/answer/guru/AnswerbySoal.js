...
import { useAnswerPagesSoal } from '../../../../hooks/queries'
...
const AnswerBySoal = () => {
    ...
    const { id } = useParams()
    const { isPending, isError, data: answer, error, isFetching, isPlaceholderData } = useAnswerPagesSoal(id,limit,page,filter)
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <>
              <div className='mb-3'> Soal : {answer?.soal.name}</div>
